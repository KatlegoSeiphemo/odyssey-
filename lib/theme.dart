...
/// Soft, calming color palette for parenting/health app
class LightModeColors {
  // Primary: Soft coral-pink for warmth and care
  static const lightPrimary = Color(0xFFFF8BA7);
  static const lightOnPrimary = Color(0xFFFFFFFF);
  static const lightPrimaryContainer = Color(0xFFFFD8E4);
  static const lightOnPrimaryContainer = Color(0xFF3E001D);

  // Secondary: Gentle teal for trust and health
  static const lightSecondary = Color(0xFF6DBAA9);
  static const lightOnSecondary = Color(0xFFFFFFFF);

  // Tertiary: Warm peach accent
  static const lightTertiary = Color(0xFFFFB084);
...
class DarkModeColors {
  // Primary: Muted coral-pink for dark mode
  static const darkPrimary = Color(0xFFFFB1C8);
  static const darkOnPrimary = Color(0xFF650033);
  static const darkPrimaryContainer = Color(0xFF8E004A);
  static const darkOnPrimaryContainer = Color(0xFFFFD8E4);

  // Secondary: Soft teal for dark mode
  static const darkSecondary = Color(0xFF8DD4C3);
  static const darkOnSecondary = Color(0xFF00382D);

  // Tertiary: Warm peach for dark mode
  static const darkTertiary = Color(0xFFFFCBA4);
  static const darkOnTertiary = Color(0xFF4F2600);
